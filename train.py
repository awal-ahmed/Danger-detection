...
from models import Conv1D, resnet50, LSTM, mobilenetv2, inceptionv3, xception
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_type', type=str, default='xception',
                        help='model to run. i.e. conv1d, resnet50, lstm, mobilenetv2, inceptionv3, xception')
